...
namespace ClientApplicationCoreTests.Controllers
{
    public class AuthControllerTests
    {
        ...
        public void Register_ReturnsView()
        {
            ...
            var mockConfiguration = new Mock<IConfiguration>(); var mockTokenHandler = new Mock<IJwtTokenHandler>();
        ...
        public void Login_Success_RedirectToAction()
        {
            ...
            mockResponseCookie.Setup(c => c.Append("loginId", mockUserId, It.IsAny<CookieOptions>()));
            ...
            var jwtToken = new JwtSecurityToken(claims: new[] { new Claim("LoginId", mockUserId) });
        ...
        {
            // Arrange
            var viewModel = new ForgetViewModel
            {
                Password = "Password@123"
            };
        ...
        public void Logout_DeleteJwtToken()
        {
            ...
            mockResponseCookie.Setup(c => c.Delete("LoginId"));
        ...
        public void Edit_ReturnsViewResult_WhenUserDetailsObtainedSuccessfully()
        {
            ...
            var mockHttpContext = new Mock<HttpContext>();
            mockHttpContext.SetupGet(h => h.User.Identity.Name).Returns("testuser"); // Replace "testuser" with desired username
            ...
            //Act
            var actual = target.EditUser() as ViewResult;
        ...
        public void Edit_ReturnsRedirectToActionResult_WhenSuccessIsFalse()
        {
            ...
            //Act
            var actual = target.EditUser() as RedirectToActionResult;
        ...
        {
            //Arrange
            var expectedUser = new UpdateUserViewModel { userId = 1, FirstName = "FirstName 1", FormFile = new FormFile(new MemoryStream(new byte[1]), 5, 4, "xyz", "xyz.pdf") };
            var mockHttpClientService = new Mock<IHttpClientService>();
            var mockConfiguration = new Mock<IConfiguration>();
            var mockTokenHandler = new Mock<IJwtTokenHandler>();
            mockConfiguration.Setup(c => c["EndPoint:CivicaApi"]).Returns("FakeEndPoint");
        ...
        {
            //Arrange
            var expectedUser = new UpdateUserViewModel { userId = 1, FirstName = "FirstName 1", ImageByte = new byte[11000], FormFile = new FormFile(new MemoryStream(new byte[1]), 5, 11000, "xyz", "xyz.jpg") };
            var mockHttpClientService = new Mock<IHttpClientService>();
            var mockConfiguration = new Mock<IConfiguration>();
            var mockTokenHandler = new Mock<IJwtTokenHandler>();
            mockConfiguration.Setup(c => c["EndPoint:CivicaApi"]).Returns("FakeEndPoint");
        ...
        {
            //Arrange
            var expectedUser = new UpdateUserViewModel { userId = 1, FirstName = "FirstName 1", FormFile = new FormFile(new MemoryStream(new byte[1]), 5, 4, "xyz", "xyz.jpg") };
            var mockHttpClientService = new Mock<IHttpClientService>();
            var mockConfiguration = new Mock<IConfiguration>();
            var mockTokenHandler = new Mock<IJwtTokenHandler>();
            mockConfiguration.Setup(c => c["EndPoint:CivicaApi"]).Returns("FakeEndPoint");
