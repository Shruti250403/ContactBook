  ...
  import { PaginationContactComponent } from '../pagination-contact/pagination-contact.component';
  ...
  describe('AddContactTfComponent', () => {
    ...
    beforeEach(() => {
      ...
      TestBed.configureTestingModule({
        imports: [HttpClientTestingModule, FormsModule, RouterTestingModule.withRoutes([{path:'pagination', component: PaginationContactComponent}])],
    ...
    it('should navigate to /contact on successful contact addition', () => {
      ...
      expect(routerSpy.navigate).toHaveBeenCalledWith(['/pagination']);
