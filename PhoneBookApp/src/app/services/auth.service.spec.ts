...
describe('AuthService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule], // Import the HttpClientModule
  ...
  it('should register user successfully',()=>{
    ...
    const req=httpMock.expectOne('http://localhost:5220/api/Auth/RegisterUser');
  ...
  it('should update password successfully',()=>{
    ...
    const req=httpMock.expectOne('http://localhost:5220/api/Auth/ForgetPassword');
    expect(req.request.method).toBe('POST');
    req.flush(mockSuccessResponse);
